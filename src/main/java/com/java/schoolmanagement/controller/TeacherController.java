...
import com.java.schoolmanagement.entity.RequestResponse;
import com.java.schoolmanagement.entity.User;
import com.java.schoolmanagement.service.UserService;
import com.java.schoolmanagement.util.FormValidationUtil;
...
public class TeacherController {
    ...
    public ModelAndView teachers(){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.addObject("title", "Öğretmen Yönetimi");
        Authentication auth = SecurityContextHolder.getContext().getAuthentication();
        if (auth != null){
    ...
    public String updateUser(@RequestParam(value = "fname") String userFirstName, @RequestParam(value = "lname") String userLastName, @RequestParam(value = "email") String userEmail, @RequestParam("t") String userType, @RequestParam("i") String id, RedirectAttributes redirectAttributes){
        ...
        if (!formValidationUtil.isEmptyInput(userFirstName)){
            if (!formValidationUtil.isEmptyInput(userLastName)){
                if (!formValidationUtil.isEmptyInput(userLastName)){
                    ...
                    if (requestResponse.getResponseCode() == 0){
                        ...
                        suc = true;
                        redirectAttributes.addFlashAttribute("message", "<i class=\"fa fa-check-circle\"></i>&nbsp;Kullanıcı bilgileri güncellendi !");
                    } else {
                    ...
                    redirectAttributes.addFlashAttribute("success", false);
                    redirectAttributes.addFlashAttribute("message", "<i class=\"fa fa-times-circle\"></i>&nbsp; E-Mail zorunlu");
                    redirectAttributes.addFlashAttribute("f", userFirstName);
                    redirectAttributes.addFlashAttribute("l", userLastName);
                    redirectAttributes.addFlashAttribute("e", userEmail);
                }
                ...
                redirectAttributes.addFlashAttribute("success", false);
                redirectAttributes.addFlashAttribute("message", "<i class=\"fa fa-times-circle\"></i>&nbsp; Soyisim zorunlu");
                redirectAttributes.addFlashAttribute("f", userFirstName);
                redirectAttributes.addFlashAttribute("l", userLastName);
                redirectAttributes.addFlashAttribute("e", userEmail);
            }
            ...
            redirectAttributes.addFlashAttribute("success", false);
            redirectAttributes.addFlashAttribute("message", "<i class=\"fa fa-times-circle\"></i>&nbsp; İsim zorunlu");
            redirectAttributes.addFlashAttribute("f", userFirstName);
            redirectAttributes.addFlashAttribute("l", userLastName);
            redirectAttributes.addFlashAttribute("e", userEmail);
        }
    ...
    public String activateAccount(@RequestParam(value = "i") String id, @RequestParam(value = "t") String type, @RequestParam("ac") String action, RedirectAttributes redirectAttributes){
        ...
        if (action.equals("0")){
            ...
            if (requestResponse.getResponseCode() == 0){
                redirectAttributes.addFlashAttribute("success", true);
                redirectAttributes.addFlashAttribute("message", "<i class=\"fa fa-check-circle\"></i>&nbsp;Kullanıcı hesabı başarıyla askıya alındı ! ");
            } else {
                redirectAttributes.addFlashAttribute("success", false);
            ...
            if (requestResponse.getResponseCode() == 0){
                redirectAttributes.addFlashAttribute("success", true);
                redirectAttributes.addFlashAttribute("message", "<i class=\"fa fa-check-circle\"></i>&nbsp;Kullanıcı hesabı başarıyla aktifleştirildi !");
            } else {
                redirectAttributes.addFlashAttribute("success", false);
                redirectAttributes.addFlashAttribute("message", requestResponse.getMessage());
            }
        ...
        if (!formValidationUtil.isEmptyInput(studentFirstName)){
            if (!formValidationUtil.isEmptyInput(studentLastName)){
                if (!formValidationUtil.isEmptyInput(studentEmail)){
                    ...
                    if (requestResponse.getResponseCode() == 0){
                        redirectAttributes.addFlashAttribute("success", true);
                        redirectAttributes.addFlashAttribute("message", "<i class=\"fa fa-check-circle\"></i>&nbsp;Öğrenci başarı ile eklendi. Öğrencinin ilk kez giriş şifresi <b>" + studentEmail + "</b>");
                    } else {
                        redirectAttributes.addFlashAttribute("success", false);
                        redirectAttributes.addFlashAttribute("message", "<i class=\"fa fa-times-circle\"></i>&nbsp;" + requestResponse.getMessage());
                    ...
                    redirectAttributes.addFlashAttribute("success", false);
                    redirectAttributes.addFlashAttribute("message", "<i class=\"fa fa-times-circle\"></i>&nbsp; Öğrenci E-Mail zorunlu ! ");
                    redirectAttributes.addFlashAttribute("fname", studentFirstName);
                    redirectAttributes.addFlashAttribute("lname", studentLastName);
                    redirectAttributes.addFlashAttribute("email", studentEmail);
                }
                ...
                redirectAttributes.addFlashAttribute("success", false);
                redirectAttributes.addFlashAttribute("message", "<i class=\"fa fa-times-circle\"></i>&nbsp; Öğrenci isim zorunlu");
                redirectAttributes.addFlashAttribute("fname", studentFirstName);
                redirectAttributes.addFlashAttribute("lname", studentLastName);
                redirectAttributes.addFlashAttribute("email", studentEmail);
            }
            ...
            redirectAttributes.addFlashAttribute("success", false);
            redirectAttributes.addFlashAttribute("message", "<i class=\"fa fa-times-circle\"></i>&nbsp; Öğrenci soyisim zorunlu");
            redirectAttributes.addFlashAttribute("fname", studentFirstName);
            redirectAttributes.addFlashAttribute("lname", studentLastName);
            redirectAttributes.addFlashAttribute("email", studentEmail);
        }
    ...
    public String newTeacher(@RequestParam("tfname") String teacherFirstName, @RequestParam("tlname") String teacherLastName, @RequestParam("temail") String teacherEmail, RedirectAttributes redirectAtt){
        ...
        if (!formValidationUtil.isEmptyInput(teacherFirstName)) {
            if (!formValidationUtil.isEmptyInput(teacherLastName)) {
                if (!formValidationUtil.isEmptyInput(teacherEmail)) {
                    ...
                    if (requestResponse.getResponseCode() == 0){
                        ...
                        redirectAtt.addFlashAttribute("message", "<i class=\"fa fa-check-circle\"></i>&nbsp;Öğretmen başarılı bir şekilde eklendi ! Öğretmenin ilk kez giriş şifresi <b>" + teacherEmail + "</b>");
                    } else {
                    ...
                    redirectAtt.addFlashAttribute("success", false);
                    redirectAtt.addFlashAttribute("message", "<i class=\"fa fa-times-circle\"></i>&nbsp;Öğretmen E-Mail zorunlu");
                    redirectAtt.addFlashAttribute("tfname", teacherFirstName);
                    redirectAtt.addFlashAttribute("tlname", teacherLastName);
                    redirectAtt.addFlashAttribute("temail", teacherEmail);
                }
                ...
                redirectAtt.addFlashAttribute("success", false);
                redirectAtt.addFlashAttribute("message", "<i class=\"fa fa-times-circle\"></i>&nbsp;Öğretmen soyisim  zorunlu");
                redirectAtt.addFlashAttribute("tfname", teacherFirstName);
                redirectAtt.addFlashAttribute("tlname", teacherLastName);
                redirectAtt.addFlashAttribute("temail", teacherEmail);
            }
            ...
            redirectAtt.addFlashAttribute("success", false);
            redirectAtt.addFlashAttribute("message", "<i class=\"fa fa-times-circle\"></i>&nbsp;Öğretmen isim zorunlu");
            redirectAtt.addFlashAttribute("tfname", teacherFirstName);
            redirectAtt.addFlashAttribute("tlname", teacherLastName);
            redirectAtt.addFlashAttribute("temail", teacherEmail);
        }
